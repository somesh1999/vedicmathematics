        ...
        <div class="container">
            ...
            <div class="col-lg-2 col-2"></div>
             ...
             <div class="col-lg-8 col-8 test">
                ...
                $endtime=date(' F d Y H:i:s', (time() + (60*10)) );
                ...
                <p>
                <div class="row opts ">
                <div class="col-3"><input type="radio" value="<?php echo $row['opt1']; ?>" name="answer<?php echo $count; ?>"> <?php echo $row['opt1']; ?></div>
                <div class="col-3"><input type="radio" value="<?php echo $row['opt2']; ?>" name="answer<?php echo $count; ?>"> <?php echo $row['opt2']; ?></div>
                <div class="col-3"><input type="radio" value="<?php echo $row['opt3']; ?>" name="answer<?php echo $count; ?>"> <?php echo $row['opt3']; ?></div>
                <div class="col-3"><input type="radio" value="<?php echo $row['opt4']; ?>" name="answer<?php echo $count; ?>"> <?php echo $row['opt4']; ?></div>
                </div>
                <p style="text-align:right; color:red; margin-top:-30px; padding-right:30px; font-size:13px; cursor:pointer;" onclick="openexplanation(`<?php echo $count; ?>`)">
                Click to explain
                </p>
                <p>
                <textarea name="explain<?php echo $count; ?>" id="explain<?php echo $count; ?>" class="form-control explain" placeholder="Write your explanation"></textarea>
                </p>
                </p>
            ...
            $('.submit-btn').html("Please wait....");
                ...
                $.ajax({
                        ...
                        success:function(data){
                            ...
                            $('.submit-btn').html("Yes");
                            window.location.href="result?course=<?php echo $_GET['course'];?>&chapter=<?php echo $_GET['chapter'];?>&token=<?php echo $endtime;?>";
